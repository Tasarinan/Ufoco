...
import { addItem, updateItem, deleteItem, resetAll } from '../../actions/item_action';
import { getAllItems, getPendingItems, getCompletedItems,getPausedItems } from '../../reducers/item';
...
class ItemList  extends Component {
  ...
  static propTypes = {
    ...
    pausedItems:PropTypes.array.isRequired,
  ...
  renderProgress() {
    ...
    return (
      ...
      <Progress percent={pausedPercentage}/>
      </div>
    );
  }
