Ufoco.Functions.Content = {};


Ufoco.Functions.Content.funcPurifyHTML = (Parameters) => {
    let arrAllowedTags = [];
    let arrAllowedAttr = [];
...
Ufoco.Functions.Content.funcSetHeadingsIDs = (Parameter) => {
...
Ufoco.Functions.Content.funcDisplayEmojis = (Parameter) => {
...
Ufoco.Functions.Content.funcClearHTMLForHTMLExport = (Parameter) => {
...
Ufoco.Functions.Content.funcClearHTMLForMarkdownExport = (Parameter) => {
...
Ufoco.Functions.Content.funcClearHTML = (Parameter) => {
    ...
    // See Ufoco.Functions.Content.funcPurifyHTML() for a better comprehension
...
Ufoco.Functions.Content.funcCleanSearch = (Parameter) => {
    // Must use while : outerHTML = innerHTML cause issues with for/forEach loops
